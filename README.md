...
I used this to create my tiny elf programs.
...
## SWF TESTING ADDITIONS:

Currently nothing but I'm adding a command history navigable using the cursor keys, and a bits mode to write data as bits interactively rather than being stuck with bits and a couple command to quickly generate a swf around your test cases.

Don't expect this program to be held to any standard of safety like libswftag, it will crash and burn if you look at it wrong.